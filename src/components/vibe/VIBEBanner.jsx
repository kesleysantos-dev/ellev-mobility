...
export default function VIBEBanner() {
  return (
    <section className="vibe-banner">
      <img src={desktopBanner} alt="A Ellev X13 chegou" className="vibe-banner__img vibe-banner__img--desktop" />
      <img src={mobileBanner} alt="A Ellev X13 chegou" className="vibe-banner__img vibe-banner__img--mobile" />
    </section>
  )
}
