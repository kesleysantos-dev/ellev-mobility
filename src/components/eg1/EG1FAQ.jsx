...
const ITEMS = [
  ...
  },
  {
    ...
    content: <p>Sim, as motos Ellev são montadas no Brasil e possuem selo de certificação.</p>,
  },
  {
...
export default function EG1FAQ() {
  return (
    <section className="eg1-faq">
      <div className="container">
        <Reveal as="h2">Dúvidas frequentes</Reveal>
        <Accordion items={ITEMS} defaultOpen={0} />
        <p className="eg1-faq__disclaimer">
