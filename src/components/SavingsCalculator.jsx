    ...
    <section className="savings">
      <div className="container savings__grid">
        <Reveal as="div" className="savings__copy">
          <h2>Andar de elétrico é mais dinheiro no seu bolso.</h2>
          <p>Com o seu veículo elétrico, cada quilômetro é economia no seu bolso — veja na prática no simulador ao lado.</p>
          ...
          <a href="#comprar" className="btn btn--pill">
            Onde comprar
          </a>
        </Reveal>
        ...
        <Reveal as="div" className="savings__panel" delay={100}>
          ...
          <div className="savings__chart">
            <div className="savings__bar-col">
              <div className="savings__bar">
                <div className="savings__seg savings__seg--maintenance" style={{ height: pct(calc.gasMaintenance) }} />
                <div className="savings__seg savings__seg--use" style={{ height: pct(calc.gasUse) }} />
              </div>
              <span className="savings__bar-label">Combustão</span>
            </div>
            <div className="savings__bar-col">
              <div className="savings__bar">
                <div className="savings__seg savings__seg--economy" style={{ height: pct(calc.elecEconomy) }} />
                <div className="savings__seg savings__seg--maintenance" style={{ height: pct(calc.elecMaintenance) }} />
                <div className="savings__seg savings__seg--use" style={{ height: pct(calc.elecUse) }} />
              </div>
          ...
          <div className="savings__legend">
            <span><i className="savings__dot savings__dot--use" />Custo de uso</span>
            <span><i className="savings__dot savings__dot--maintenance" />Custo de manutenção</span>
            <span><i className="savings__dot savings__dot--economy" />Economia</span>
          </div>
        </Reveal>
      </div>
    </section>
